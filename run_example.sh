...
echo "   ./target/release/rtsp-time-logger rtsp://admin:bnk%4013032018@192.168.0.106:554"
echo " ./target/release/rtsp-time-logger rtsp://127.0.0.1:8554/cam"
echo "2. Test with custom output dir:"
echo "   ./target/release/rtsp-time-logger rtsp://admin:bnk%4013032018@192.168.0.106:554 my_frames"
echo ""
echo "3. Debug mode:"
